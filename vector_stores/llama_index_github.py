import pickle
import os
from llama_index import OpenAIEmbedding, ServiceContext, download_loader, GPTVectorStoreIndex, StorageContext
...
vector_store=PineconeVectorStore(client=client, index_name='ssk', collection_name='github-llama-index', environment='us-east-1-aws')
